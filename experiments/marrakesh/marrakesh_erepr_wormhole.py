...
The buildable wormhole capability (see systrophe.quantum_info.erepr_channel,
...
def _syk_wormhole_depth(service, snap) -> dict:
    ...
    can't run clean). Uses systrophe.quantum_info.size_winding / erepr_channel to build a
    1-Trotter-step SYK scramble on 3+3 qubits."""
    from systrophe.quantum_info.erepr_channel import syk_hamiltonian, _syk_coupling_V
