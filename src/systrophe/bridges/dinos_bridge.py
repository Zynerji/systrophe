...
def _ensure_dinos_import() -> None:
    ...
    # __file__ is now at src/systrophe/bridges/dinos_bridge.py; the
    # vendored subset lives at src/systrophe/_dinos_vendored/ (sibling of
    # the bridges/ subpackage, not inside it).
    vendored_dir = str(pathlib.Path(__file__).parent.parent / "_dinos_vendored")
