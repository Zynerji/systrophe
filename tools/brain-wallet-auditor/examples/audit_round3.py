"""Round 3 — further dictionary expansion targeting categories that hit in round 1.

Multi-API fallback, 2 threads, deduplicates against any prior round's
successful queries.
"""
...
def main():
    candidates = build_round3_candidates()
    print(f"Round 3 dictionary: {len(candidates)} candidates")
    ...
    print(f"  estimated wall clock: ~{len(tasks) * 0.5 / 60:.1f} min")
    print()
    ...
    out_path = HERE / "audit_round3_results.json"
