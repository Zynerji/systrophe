...
def retrofit_feedback_shell() -> dict:
    from systrophe.qftcs.feedback_amplified_shell import required_drive_power
...
def retrofit_krasnikov_ring() -> dict:
    try:
        from systrophe.geometry.krasnikov_ring import krasnikov_ring_with_noise_NEC_radial
    except ImportError:
