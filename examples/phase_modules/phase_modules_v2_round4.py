...
def m_chronology_protection():
    try:
        from systrophe.ctc.chronology_protection import chronology_protection_study
    except ImportError:
        return None
...
def m_particle_creation():
    from systrophe.qftcs.particle_creation import (
...
def m_topology_change():
    from systrophe.geometry.topology_change import (
...
def m_cauchy_stability():
    try:
        from systrophe.ctc.cauchy_stability import (
