...
def sweep_bms_soft_hair():
    from systrophe.quantum_info.bms_soft_hair import supertranslation_mode_amplitudes
...
def sweep_modified_dispersion():
    from systrophe.geometry.vanstockum import VanStockumInterior
    try:
        from systrophe.qftcs.modified_dispersion import modified_speed_of_light
    except ImportError:
...
def sweep_vacuum_polarization():
    from systrophe.geometry.vanstockum import VanStockumInterior
    try:
        from systrophe.qftcs.vacuum_polarization import (
